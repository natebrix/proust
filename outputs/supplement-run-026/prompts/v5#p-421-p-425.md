  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.78,
      "evidence": "« Pas une fois celui de la pâtissière ne se posa sur mon amie ... C'était peu aimable pour mon amie, mais, dans le fond, je fus enchanté qu'Albertine reçût cette petite leçon et vît que souvent les femmes ne faisaient pas attention à elle. »",
      "explanation": "In the pastry shop, the pastry chef obstinately ignores Albertine despite her attempts to catch her gaze. The narrator notes this fact (and rejoices in it), which functions locally as a small social humiliation for Albertine."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.75,
      "explanation": "The pastry chef's refusal of public attention, reported without counterbalance, locally diminishes Albertine's assurance and perceived radiance."
    }
  ],
  "ambiguities": [],
  "unit_id": "v5#p-421-p-425"
}
