  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.94,
      "evidence": "« D'abord on ne comprend pas ce que vous dites… »; « Pauvre Saniette, je ne veux pas que vous le rendiez malheureux » (ton de fausse pitié); rires des fidèles; « La Zerbine ?… Ah ! le pédant, c'est vous… Non, mais il est toqué »; allusion cruelle à la « galantine ».",
      "explanation": "Under the impetus of Mr. and Mrs. Verdurin, the group publicly ridicules Saniette (speech defect, references, ruin), provoking a collective humiliation. The narrator frames the episode as a revealing social cruelty."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.94,
      "explanation": "Saniette is publicly mocked and isolated by the circle, enduring a humiliating sidelining despite a brief respite."
    }
  ],
  "ambiguities": [],
  "unit_id": "v4-p2#p-351-p-355"
}
