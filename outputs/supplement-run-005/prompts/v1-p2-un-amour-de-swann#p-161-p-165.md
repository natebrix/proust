  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.86,
      "evidence": "« l'indifférence que Swann jouait ... tomba »; il « avait dans l'âme le manque de souplesse »; puis s’écrie: « il faut que nous trouvions cette dame; c’est de la plus haute importance. »",
      "explanation": "The narrator reveals Swann's false indifference and anxious dependence; when Rémi suggests returning, the mask falls, and Swann shows himself feverishly attached to finding Odette."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.86,
      "explanation": "He shifts from a feigned indifference to a worried insistence, which locally undermines his emotional control."
    }
  ],
  "ambiguities": [],
  "unit_id": "v1-p2-un-amour-de-swann#p-161-p-165"
}
