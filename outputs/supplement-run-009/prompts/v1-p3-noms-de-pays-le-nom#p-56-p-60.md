  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.88,
      "evidence": "«Odette? ... elle ne doit plus être de la première jeunesse ! Je me rappelle que j'ai couché avec elle le jour de la démission de Mac-Mahon.»",
      "explanation": "Strollers reduce her by a comment on her age and recall a sexual reputation, which undermines her social prestige."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.86,
      "explanation": "Her esteem is undermined by the public gossip linking aging and sexual past."
    }
  ],
  "ambiguities": [],
  "unit_id": "v1-p3-noms-de-pays-le-nom#p-56-p-60"
}
...
– Vous savez qui c'est ? Odette ! Cela ne vous dit rien ? Odette de Crécy ?
