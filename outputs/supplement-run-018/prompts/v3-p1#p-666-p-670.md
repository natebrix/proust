  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.84,
      "evidence": "« La marquise ne répondit rien » … « Mme de Villeparisis dit gaiement à duchesse de Guermantes : »",
      "explanation": "Mme de Villeparisis withholds any reply to Bloch and then turns cheerfully to address the duchesse de Guermantes, signaling a social slight and exclusion of Bloch from her attention."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.8,
      "explanation": "He is locally excluded from valued interaction when the marquise ignores him and redirects her attention to the duchesse."
    }
  ],
  "ambiguities": [],
  "unit_id": "v3-p1#p-666-p-670"
}
