  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.84,
      "evidence": "« Je vous avoue pourtant que je ne crois pas qu'elle [Gilberte] approchera jamais de sa mère… »",
      "explanation": "Norpois delivers a comparative judgment that implicitly elevates Odette above her daughter; his assessment carries social-authoritative weight within the scene."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.84,
      "explanation": "Odette is locally elevated by Norpois's comparative praise, positioned as superior to her daughter."
    }
  ],
  "ambiguities": [],
  "unit_id": "v2-p1-autour-de-mme-swann#p-79-p-84"
}
