  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.82,
      "evidence": "« J'avoue que je l'ai délaissé pour une soirée assez différente. J'ai dîné chez une femme dont vous avez peut-être entendu parler, la belle Madame Swann. »",
      "explanation": "By openly preferring Mme Swann's dinner to an official Foreign Affairs banquet and calling her 'la belle', Norpois confers social validation and attractiveness on her household."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.82,
      "explanation": "Norpois’s choice and compliment locally elevate Mme Swann’s standing as a desirable hostess."
    }
  ],
  "ambiguities": [],
  "unit_id": "v2-p1-autour-de-mme-swann#p-56-p-60"
}
