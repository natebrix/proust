  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.9,
      "evidence": "« car elle est si vulgaire et surtout, la pauvre petite, elle est tellement bête ! ! ! »; il réévalue le salon des Verdurin comme « ridicule », « sot », « ignominieux » parce qu’Odette y aimera un autre que lui.",
      "explanation": "Under the effect of jealousy, Swann belittles Odette (and, by extension, her circle). The tone is presented as 'a bit artificial', suggesting an ironic distance."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.85,
      "explanation": "She is locally disparaged by Swann as 'vulgar' and 'stupid', which diminishes her in the ongoing subjective evaluation."
    }
  ],
  "ambiguities": [],
  "unit_id": "v1-p2-un-amour-de-swann#p-361-p-365"
}
