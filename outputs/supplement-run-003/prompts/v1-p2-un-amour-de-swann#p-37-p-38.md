...

{
  "characters_present": [
    ...
    {
      "canonical_name": "le grand-père du narrateur",
      "surface_forms": [
        "Mon grand-père",
        "le grand-père du narrateur"
      ],
  ...
  "appraisal_events": [
    {
      "event_id": "E1",
      "source": "le grand-père du narrateur",
      "target": "Swann",
      "type": "discredit_association",
      "polarity": "negative",
      "narrative_stance": "neutral_report",
      "confidence": 0.9,
      "evidence": "« c'est bien par là que devait finir Swann. Joli milieu ! ... Ah bien ! nous allons avoir de l'agrément si Swann s'affuble des petits Verdurin. »; il tenait les Verdurin pour « la bohème et la racaille ».",
      "explanation": "The grandfather disparages Swann by linking him to a milieu considered low (the Verdurins) and refuses to help, presenting this association as dishonorable."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.88,
      "explanation": "In the eyes of the grandfather, the association with the Verdurins marks a decline in social status for Swann."
    }
  ],
  "ambiguities": [],
  "unit_id": "v1-p2-un-amour-de-swann#p-37-p-38"
}
