  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.87,
      "evidence": "Regards ritualisés, poursuite jusqu’à la rue, puis retour et invitation: « Entrez, on vous donnera tout ce que vous voudrez. » La porte se referme sur eux.",
      "explanation": "The narrator stages a mutual recognition and a tacit agreement between Charlus and Jupien, culminating in the invitation to enter, marking a local success of intimacy initiated with ritual ease and beauty."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.86,
      "explanation": "Charlus obtains the desired reciprocity and moves to intimacy, which constitutes an immediate emotional success."
    }
  ],
  "ambiguities": [],
