  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.86,
      "evidence": "« ... reprit le duc, à qui duchesse de Guermantes coupa la parole, sans écouter. »",
      "explanation": "The duchess interrupts the duke and ignores his comments, marginalizing him in the exchange in favor of a conversation with Swann."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.86,
      "explanation": "His conversational authority is diminished by the interruption and the disinterest displayed by the duchess."
    }
  ],
  "ambiguities": [],
  "unit_id": "v3-p2#p-701-p-705"
}
