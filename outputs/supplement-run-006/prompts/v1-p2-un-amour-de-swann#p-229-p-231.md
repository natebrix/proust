  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.9,
      "evidence": "« Ce qu'il m'amuse quand il s'emballe comme ça »; « Tu sais pourtant qu'il parle bien »; puis au peintre: « Mais nous ne croyons pas que vous exagérez, nous voulons seulement que vous mangiez ».",
      "explanation": "Mme Verdurin publicly delights in and validates the painter's eloquent performance, explicitly denying he exaggerates and framing his talk as a highlight of the dinner."
    }
  ],
  "status_effects": [
    {
      "character": "le peintre",
      ...
      "confidence": 0.9,
      "explanation": "Within the salon scene, the painter's standing rises as the hostess openly praises and endorses his discourse."
    }
  ],
  "ambiguities": [],
  "unit_id": "v1-p2-un-amour-de-swann#p-229-p-231"
}
...
Sauf au moment où il avait dit : « plus fort que la Ronde », blasphème qui avait provoqué une protestation de Mme Verdurin qui tenait « la Ronde » pour le plus grand chef-d'oeuvre de l'univers avec « la Neuvième » et « la Samothrace », et à : « fait avec du caca », qui avait fait jeter à comte de Forcheville un coup d'oeil circulaire sur la table pour voir si le mot passait et avait ensuite amené sur sa bouche un sourire prude et conciliant, tous les convives, excepté Swann, avaient attaché sur le peintre des regards fascinés par l'admiration.
