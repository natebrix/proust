  ...
  "appraisal_events": [
    {
      ...
      "confidence": 0.94,
      "evidence": "« le sens critique … lui faisait complètement défaut, … il prenait tout au pied de la lettre »; Mme Verdurin conclut qu’« il … ne connaît pas par lui-même la valeur des choses et il s’en rapporte à ce que nous lui en disons »; les Verdurin remplacent un rubis par « une pierre reconstituée » en lui laissant entendre qu’on en voit rarement d’aussi belle.",
      "explanation": "The narrator presents Cottard as lacking critical sense and gullible; the example of the invitation to Sarah Bernhardt and the rigged gift from the Verdurins confirm his naivety and manipulability."
    }
  ],
  "status_effects": [
    {
      ...
      "confidence": 0.9,
      "explanation": "Locally, Cottard is clearly diminished: he appears without discernment, takes everything literally, and is tricked by the Verdurins."
    }
  ],
  "ambiguities": [],
  "unit_id": "v1-p2-un-amour-de-swann#p-41-p-45"
}
