...
def build_character_cross_lens_analysis(review):
    from .app_exports import build_character_cross_lens_analysis as impl
...
def build_character_annotation_counts(review):
    from .app_exports import build_character_annotation_counts as impl
...
def write_character_cross_lens_analysis_artifacts(analysis, json_output=None, markdown_output=None):
    from .export_artifacts import write_character_cross_lens_analysis_artifacts as impl
...
def render_character_chapter_analysis_markdown(analysis):
    from .export_artifacts import render_character_chapter_analysis_markdown as impl

    return impl(analysis)


def write_character_chapter_analysis_artifacts(analysis, json_output=None, markdown_output=None):
    from .export_artifacts import write_character_chapter_analysis_artifacts as impl

    return impl(analysis, json_output=json_output, markdown_output=markdown_output)


def render_character_annotation_counts_markdown(analysis):
    from .export_artifacts import render_character_annotation_counts_markdown as impl
...
def render_character_profile_cards_markdown(analysis):
    from .export_artifacts import render_character_profile_cards_markdown as impl

    return impl(analysis)


def write_character_profile_cards_artifacts(analysis, json_output=None, markdown_output=None):
    from .export_artifacts import write_character_profile_cards_artifacts as impl

    return impl(analysis, json_output=json_output, markdown_output=markdown_output)


def write_chapter_overlay_artifacts(dataset, output_dir):
    from .export_artifacts import write_chapter_overlay_artifacts as impl

    return impl(dataset, output_dir)


def render_character_pages_markdown(analysis):
    from .export_artifacts import render_character_pages_markdown as impl

    return impl(analysis)


def write_character_pages_artifacts(analysis, json_output=None, markdown_output=None):
    from .export_artifacts import write_character_pages_artifacts as impl

    return impl(analysis, json_output=json_output, markdown_output=markdown_output)


def render_chapter_summary_export_markdown(analysis):
    from .export_artifacts import render_chapter_summary_export_markdown as impl

    return impl(analysis)


def write_chapter_summary_export_artifacts(analysis, json_output=None, markdown_output=None):
    from .export_artifacts import write_chapter_summary_export_artifacts as impl
