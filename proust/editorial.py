...
CHARACTER_PAGE_PILOT_EDITORIAL = {
    ...
    "Odette": {
        ...
        "summary": "Odette is one of the clearest cross-lens split figures in the novel: she rises strongly in prestige while remaining far more unstable in belonging and immediate advantage.",
        "why_interesting": [
    ...
    "Robert de Saint-Loup": {
        "subheading": "An ever-present aristocratic figure whose prestige often holds even where belonging and immediate advantage give way.",
        "summary": "Robert de Saint-Loup appears throughout the book and shows one of the largest lens spreads in the novel, especially where aristocratic polish and emotional belonging pull apart.",
        "why_interesting": [
    ...
    "Swann": {
        "subheading": "The most-scored figure in the novel, overwhelmingly shaped by repeated immediate, social, and emotional losses.",
        "summary": "Swann dominates the novel by sheer presence, and his overall pattern remains broadly and repeatedly negative across all three lenses.",
        "why_interesting": [
    ...
    "Albertine": {
        "subheading": "A constant presence across the book whose strongest shaping comes from imprisonment, suspicion, disappearance, and loss.",
        "summary": "Albertine is one of the largest and most persistently negative figures in the novel, with her strongest shaping concentrated in the prison and disappearance chapters.",
        "why_interesting": [
    ...
    "baron de Charlus": {
        "subheading": "A highly volatile major figure whose negative scores are spread across salon, sexual, and wartime terrains.",
        "summary": "baron de Charlus is a constant presence and a highly volatile figure, his negative scores spread across salon, sexual, and wartime configurations rather than one single narrative block.",
        "why_interesting": [
    ...
    "duchesse de Guermantes": {
        "subheading": "The novel's clearest uniformly positive great-world figure, with command and symbolic force holding across all three lenses.",
        "summary": "duchesse de Guermantes is the strongest uniformly positive figure in the novel, with her social command and symbolic force holding across every lens rather than depending on a narrow chapter exception.",
        "why_interesting": [
    ...
    "Mme de Villeparisis": {
        ...
        "summary": "Mme de Villeparisis is one of the clearest moderate split figures in the novel: she remains comparatively strong in prestige while advantage and inclusion drift downward or oscillate by chapter.",
        "why_interesting": [
    ...
    "Françoise": {
        ...
        "summary": "Françoise accumulates as a broadly negative figure across the book, though her profile is not flat: a small number of chapters briefly reverse the trend before the longer downward pull returns.",
        "why_interesting": [
    ...
    "Mme Verdurin": {
        "subheading": "A salon figure whose overall reading is broadly negative across all three lenses.",
        "summary": "Mme Verdurin is one of the clearest broadly negative salon figures in the novel, with losses in advantage, prestige, and inclusion all reinforcing rather than offsetting one another.",
        "why_interesting": [
    ...
    "la grand-mère": {
        ...
        "summary": "la grand-mère accumulates as one of the book's more strongly negative recurring figures, with the harshest pressure falling on inclusion and broad valuation rather than on a narrow prestige story alone.",
        "why_interesting": [
    ...
    "Bloch": {
        ...
        "summary": "Bloch is one of the clearest cases of consistent negative treatment in the novel, with repeated losses in advantage, prestige, and inclusion reinforcing each other rather than splitting apart.",
        "why_interesting": [
    ...
    "duc de Guermantes": {
        "subheading": "A revealing reversal-of-expectation figure: high rank without correspondingly positive scores.",
        "summary": "duc de Guermantes is one of the novel's most revealing reversals of expectation: despite formal rank, his scores are broadly negative across all three lenses.",
        "why_interesting": [
    ...
    "Bergotte": {
        ...
        "summary": "Bergotte is one of the novel's clearest positive symbolic figures, with his literary authority translating into very high advantage and prestige across several distinct narrative zones.",
        "why_interesting": [
    ...
    "Legrandin": {
        ...
        "summary": "Legrandin is a broadly negative figure whose profile is shaped by repeated discredit and awkward self-positioning, even though a few isolated passages briefly interrupt the downward pattern.",
        "why_interesting": [
    ...
    "Mme de Cambremer": {
        "subheading": "A compact but stable negative case: rare in the novel, but strongly downward wherever she appears.",
        "summary": "Mme de Cambremer is a compact but stable negative case: she doesn't appear as often as the novel's biggest characters, but what is there reads overwhelmingly downward in advantage, prestige, and inclusion.",
        "why_interesting": [
    ...
    "M. Vinteuil": {
        "subheading": "A surprising overall positive whose late recoveries outweigh strongly negative early material.",
        "summary": "M. Vinteuil is one of the more surprising positive figures in the novel: despite some strongly negative early material, his scores end up decisively positive, especially in inclusion.",
        "why_interesting": [
